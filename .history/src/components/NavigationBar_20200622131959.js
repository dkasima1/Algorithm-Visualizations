        ...
        <div>
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav.Link href="#features">Sorting</Nav.Link>
                    <Nav.Link href="#pricing">MST</Nav.Link>
                    <Nav.Link href="#pricing">Shortest Path</Nav.Link>
                    <Nav.Link href="#pricing">Flow</Nav.Link>
